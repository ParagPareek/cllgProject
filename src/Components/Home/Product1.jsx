...
import product1 from "./Item1";  // Ensure you have the correct data here
...
const Product1 = () => {
  ...
  const sorttest = () => {
    const ratingValue = parseInt(ratingVal); 
    const filterByRating = searchResults.filter((item) => item.rating >= ratingValue);
